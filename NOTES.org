...
Then check ip address assignment via 'ip addr show interface1s0',
and check the routing table with 'ip route show'. If the routing
got set up correctly, a line starting with "default via ..." should appear.
