...
### System Containers
After starting the build process of a Guix System build, run `/gnu/store/<hash>-system` in your terminal. This will start the built system as a container, and will output you a process PID. To enter the container, simple run `guix container exec <PID> /run/current-system/profile/bin/bash --login`.
